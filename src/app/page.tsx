...
export default async function HomePage() {
  const [featuredProperties, totalCount, cityCount] = await Promise.all([
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              { value: `${cityCount.length}`, label: "Cidades Atendidas", icon: MapPin },
              { value: "100%", label: "Fotos Reais", icon: Shield },
              { value: "24h", label: "Tempo de Resposta", icon: Search },
            ].map((stat) => (
              <div
                key={stat.label}
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a
                  href="https://wa.me/5511999999999?text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20os%20imóveis."
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-green-600 text-white font-semibold text-base hover:bg-green-700 transition-all duration-300"
                >
