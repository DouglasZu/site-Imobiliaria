...
export async function generateMetadata({ params }: PropertyPageProps): Promise<Metadata> {
  ...
  const property = await prisma.property.findUnique({
    where: { id },
    select: { title: true, description: true, city: true, price: true, purpose: true },
  });
  ...
  return {
    ...
    description: `${property.title} em ${property.city} por ${formatPrice(property.price, property.purpose)}. ${property.description.slice(0, 120)}`,
  };
}
...
export default async function PropertyPage({ params }: PropertyPageProps) {
  ...
  const whatsappLink = getWhatsAppLink(property.title, property.whatsappPhone || undefined);
          ...
          >
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full px-6 py-4 rounded-xl bg-green-600 text-white font-semibold text-base hover:bg-green-700 transition-all duration-300"
